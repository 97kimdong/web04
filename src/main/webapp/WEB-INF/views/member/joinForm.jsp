...
<body>
    ...
    <div id="ct">
        <div class="loginbox">
            <div class="join-page">
                <div class="form">
                    <form class="join" id="join" action="insert" method="post">
                        ...
                        <input type="password" placeholder="password_ck" name="userpw2" id="userpw2" required />
                        ...
                        <input type="text" placeholder="address" name="addr1" id="addr1" onclick="findAddr();"
                            readonly required />
						...
						<input type="date" placeholder="birth" name="birth" id="birth" required />
                    ...
                    <script type="text/javascript">
                        ...
                        function idck() {
                            var xPos = (document.body.offsetWidth / 2) - (300 / 2);
                            var yPos = (document.body.offsetHeight / 2) - (200 / 2);
                            
                            var ck_id = document.getElementById("userid").value;
                            var href = './IDCK?userid=' + ck_id
                            window.open(href, "pop_name", "width=300, height=200, left=" + xPos + ", top=" + yPos +
