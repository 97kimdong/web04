            ...
            <div class="board">
                ...
                <div class="table_warp">
                    <table>
                        ...
                        <tbody>
                        <c:forEach items="${memberList }" var="list1">
                            <tr class="even">
                                <td class="td_num2">${list1.username }</td>
                                <td class="td_subject" style="padding-left:0px">
                                    <div class="bo_tit">
                                        <a href="">${list1.userid } </a>
                                    </div>
                                </td>
                                <td class="td_name sv_use"><span class="sv_member">${list1.email }</span></td>
                                <td class="td_num">${list1.tel }</td>
                                <td class="td_datetime">${list1.birth }</td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
