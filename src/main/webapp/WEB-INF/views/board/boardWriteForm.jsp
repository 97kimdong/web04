                ...
                <table class="table" id="table">
                    <tbody>
                        ...
                        <tr>
                            <th>작성자</th>
                            <td>
                                <input type="text" name="nickname" id="nickname" value="admin" required readonly>
                            </td>
                        </tr>
                        <tr>
                            <th>내용</th>
                            <td>
                                <textarea cols="100" rows ="10" name="content" id="content"  required  ></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3" class="cols">
                                ...
                                <a href="${path }/board/list.do" class="button is-info">목록</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
